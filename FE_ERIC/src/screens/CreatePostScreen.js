...
import { SafeAreaView, Image, TextInput, ScrollView, StyleSheet, Text, View, FlatList, Dimensions, TouchableOpacity } from "react-native";
...
const CreatePostScreen = () => {
    ...
    const renderAddButton = () => {
      return (
        <TouchableOpacity onPress={()=> addMoreImage()}
          style={{...styles.ingredientItemWrapper,borderWidth:1, borderColor: '#333333'}}>
          <View  style={{...styles.ingredientImage, justifyContent:'center', alignItems:'center'}} >
    ...
    <SafeAreaView style={styles.container}>
          ...
          <ScrollView>
            <View style={{ justifyContent: 'center',    alignItems:'center', marginVertical: 5}}>
              {!pickedImagePath ? (
                  <TouchableOpacity
                      style={{  ...styles.shadowTouch,  justifyContent: 'center', alignItems:'center', width: windowWidth *4/5, height: windowHeight *1/5,   borderRadius: 15 ,  borderColor: Color.darkGray, backgroundColor: Color.white,  borderWidth: 1  }} 
                  >
                    <Text>Add Image</Text>
                  </TouchableOpacity>
              ) : (
                  <Image source={{uri: pickedImagePath}} 
                        style={{   justifyContent: 'center', alignItems:'center', width: windowWidth *4/5, height:   windowHeight *1/5,   borderRadius: 15 ,  borderColor: Color.black, backgroundColor: Color.white, borderWidth: 1 
                        }}                   
                  />
              )}
            </View>
            ...
            <View style={styles.ingredientsWrapper}>
              ...
              <View style={styles.ingredientsListWrapper}>
                <FlatList
                  ...
                  ListFooterComponent={ imageUris.length <5  ? renderAddButton : null } 
